...
public interface PostRepository extends JpaRepository<Posts, Long> {
    @Query(value = "SELECT id, date, content FROM public.posts p WHERE p.active = TRUE AND p.community_id IS NULL ORDER BY p.date DESC", nativeQuery = true)
    ...
    WHERE p.active = TRUE AND p.community_id IS NULL
